...
class ExtracteurGroq(InterfaceLLM):
    ...
    def extraire_besoin(self, message: str, besoin_actuel: Besoin) -> Besoin:
        ...
        try:
            ...
            logger.error("Appel Groq échoué lors de l'extraction du besoin : %s", erreur)
        ...
        if besoin_extrait is None:
            logger.error(
                "Réponse Groq invalide lors de l'extraction du besoin, contenu reçu : %r", contenu_brut
            )
            return besoin_actuel
